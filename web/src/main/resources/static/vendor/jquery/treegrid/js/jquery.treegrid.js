...
(function($) {
	...
	function _initTree(options) {
		...
		return $this.each(function() {
			...
			$this
				...
				.on('dblclick', '>tbody>tr>td:first-child>.treegrid-container>.treegrid-expander', _expanderRecursiveClick);
	...
	function _expanderRecursiveClick() {
		var $this = $(this);
		if ($this.hasClass('treegrid-expander-expanded') || $this.hasClass('treegrid-expander-collapsed')) {
			methods.expandRecursive.call($this.closest('tr'));
		}
	};
